...
export default function ScannerSection() {
  return (
    <section className="mx-auto mt-12 max-w-7xl px-4 sm:mt-14 sm:px-6 md:mt-16 md:px-8 lg:px-10">
      <div className="grid items-center gap-8 rounded-[2rem] bg-gradient-to-b from-leaf-50 to-[#e7f1e0] p-6 sm:gap-10 sm:rounded-[2.5rem] sm:p-8 md:gap-12 md:p-10 lg:grid-cols-2 lg:p-14">
        <div>
          ...
          <h2 className="mt-4 text-[26px] font-extrabold leading-[1.2] text-ink sm:text-[32px] md:text-[36px] lg:text-[40px] lg:leading-[1.15]">
